...
const d = {
  ...
  budget:       "M20 7H4a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2zM16 13h.01M2 7l10-4 10 4",
...
export default function MobileDrawer({ open, onClose, activeAccount }) {
  ...
  const showSpending   = has("spendingDashboard") || has("receiptsLedger") || has("budget");
        ...
        <nav className="flex-1 pb-4">
          ...
          {showSpending && (
            <>
              ...
              {has("budget")            && <NavItem to="/budget/overview"          label="Budget & Goals"  iconD={d.budget}    onClose={onClose} />}
            </>
          )}
          {showResearch && (
            <>
          ...
          {showTax && (
            <>
              ...
              {has("taxReturn") && <NavItem to="/tax/return" label="Tax Return" iconD={d.taxReturn} onClose={onClose} />}
            </>
          )}
        </nav>
